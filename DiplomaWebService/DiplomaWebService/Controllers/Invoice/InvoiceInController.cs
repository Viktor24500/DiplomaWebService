...
namespace DiplomaWebService.Controllers.Invoice
{
    public class InvoiceInController : Controller
    {
        ...
        public async Task<IActionResult> GetAllInvoicesIn()
        {
            ...
            Result<InvoiceInViewModel> invoiceInModel = await GetInvoiceInModel(result.Data, username.Data, username.Data[0]);
        ...
        private async Task<Result<InvoiceInViewModel>> GetInvoiceInModel(List<InvoiceIn> invoices, string username, char usernameFirstLetter)
        {
            ...
            invoiceModel.Data = new InvoiceInViewModel(usernameFirstLetter, username, invoices, resultSector.Data, resultDocumentType.Data,
