...
namespace DiplomaWebService.Models.Invoice.Out
{
    ...
    {
        public InvoiceOut(int id, DateTime invoiceDate, string number,
                    ...
                    List<InvoicePositionOut> invoicePositions)
        {
            Id = id;
        ...
        public List<InvoicePositionOut> InvoicePositions { get; set; }
    }
}
