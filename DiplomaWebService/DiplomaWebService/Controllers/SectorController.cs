...
namespace DiplomaWebService.Controllers
{
    public class SectorController : Controller
    {
        ...
        private SectorViewModel CreateViewModel(string username, char usernameFirstLetter, List<Sector> sectors)
        {
            SectorViewModel model = new SectorViewModel(usernameFirstLetter, username, sectors);
            return model;
        }
